        ...
        <div className="border-b border-gray-100 px-4 md:px-8 py-3 flex items-center justify-between gap-4 md:gap-8 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 md:gap-5 shrink-0">
            <Link href="/cart" className="relative p-2 hover:bg-gray-50 rounded-xl transition-all group">
              ...
              <span className="absolute top-0 right-0 bg-[#d42c2c] text-white text-[9px] font-black px-1.5 py-0.5 rounded-full border-2 border-white shadow-sm">0</span>
            </Link>
            <Link href="/profile" className="hidden lg:flex items-center gap-3 bg-[#2d5a27] text-white px-5 py-2 rounded-xl hover:bg-[#1f3f1b] transition-all shadow-md group">
            ...
            <Link href="/profile" className="lg:hidden p-2 hover:bg-gray-50 rounded-xl transition-all">
